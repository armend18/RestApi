...
public class MoviesContext : IdentityDbContext<User>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Comment>()
            ...
            //delete comment but not children
        modelBuilder.Entity<Comment>()
    ...
    public DbSet<MovieDirector> Movie_Directors => Set<MovieDirector>();
    
    public DbSet<MovieGenres> Movie_Genres => Set<MovieGenres>();
    public DbSet<MovieCast> Movie_Casts => Set<MovieCast>();
